...
public class Queue {
	...
	/**
	 * Ein Knoten besteht aus einem Inhaltsobjekt und einem Nachfolgeknoten.
	 */
	private class Node {
	...
	/**
	 * Das Objekt pObjekt wird an die Schlange angehaengt. Falls pObject gleich
	 * null ist, bleibt die Schlange unveraendert.
	 * 
	 * @param pObject
	 *            das anzuhaengende Objekt
	 */
	 ...
	 * unveraendert. Falls die Schlange leer ist, wird null zur&uuml;ck gegeben.
	 * 
	 * @return das erste Objekt der Schlange oder null, falls die Schlange leer
	 *         ist.
	 */
	public Object front() {
		if (this.isEmpty()) {
