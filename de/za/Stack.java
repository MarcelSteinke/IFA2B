 ...
 * </p>
 * <p>
 * Objekte der Klasse Stack (Keller, Stapel) verwalten beliebige Objekte nach
 * dem Last-In-First-Out-Prinzip, d.h. das zuletzt abgelegte Objekt wird als
 * erstes wieder entnommen.
 * </p>
 * 
 * <p>
...
public class Stack {
	...
	/**
	 * Das Objekt pObject wird oben auf den Stapel gelegt. Falls pObject gleich
	 * null ist, bleibt der Stapel unveraendert.
	 * 
	 * @param pObject
	 *            ist das einzufuegende Objekt.
	 */
	 ...
	 * unveraendert. Falls der Stapel leer ist, wird null zurueck gegeben.
	 * 
