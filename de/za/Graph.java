...
public class Graph {
	...
	/**
	 * Ein neuer Graph wird erzeugt. Er enthaelt noch keine Knoten.
	 */
	public Graph() {
		nodeList = new List();
		edgeList = new List();
	...
	/**
	 * Die Anfrage liefert true, wenn der Graph keine Knoten enthaelt,
	 * andernfalls liefert die Anfrage false.
	 * 
	...
	/**
	 * Der Knoten pNode wird dem Graphen hinzugefuegt. Falls bereits ein Knoten
	 * mit gleichem Namen im Graphen existiert, wird dieser Knoten nicht
	 * eingefuegt. Falls pNode null ist, veraendert sich der Graph nicht.
	 * 
	 * @param pNode
	 *            neuer Knoten
	 */
	...
	/**
	 * Die Anfrage liefert true, wenn ein Knoten mit dem Namen pName im Graphen
	 * existiert. Sonst wird false zurueck gegeben.
	 * 
	 * @param pName
	 *            Knoten
	...
	/**
	 * Die Anfrage liefert den Knoten mit dem Namen pName zurueck. Falls es
	 * keinen Knoten mit dem Namen im Graphen gibt, wird null zurueck gegeben.
	 * 
	 * @param pName
	 *            Knotenbezeichnung
	...
	/**
	 * Falls pNode ein Knoten des Graphen ist, so werden er und alle mit ihm
	 * verbundenen Kanten aus dem Graphen entfernt. Sonst wird der Graph nicht
	 * veraendert.
	 * 
	 * @param pNode
	 *            Knoten
	...
	/**
	 * Falls eine Kante zwischen pNode1 und pNode2 noch nicht existiert, werden
	 * die Knoten pNode1 und pNode2 durch eine Kante verbunden, die das Gewicht
	 * pWeight hat. pNode1 ist also Nachbarknoten von pNode2 und umgekehrt.
	 * Falls eine Kante zwischen pNode1 und pNode2 bereits existiert, erhaelt
	 * sie das Gewicht pWeight. Falls einer der Knoten pNode1 oder pNode2 im
	 * Graphen nicht existiert oder null ist, veraendert sich der Graph nicht.
	 * 
	 * @param pNode1
	 *            Knoten
	 * @param pNode2
	...
	public void addEdge(GraphNode pNode1, GraphNode pNode2, double pWeight) {
		if (pNode1 != null && pNode2 != null && hasNode(pNode1)
				&& hasNode(pNode2)) {
	...
	/**
	 * Die Anfrage liefert true, falls eine Kante zwischen pNode1 und pNode2
	 * existiert, sonst liefert die Anfrage false.
	 * 
	 * @param pNode1
	 *            Knoten
	 * @param pNode2
	 ...
	 * Falls die Kante nicht existiert, wird Double.NaN (not a number) zurueck
	 * gegeben.
	 * 
	 * @param pNode1
	 *            Knoten
	...
	/**
	 * Falls pNode1 und pNode2 nicht null sind und eine Kante zwischen pNode1
	 * und pNode2 existiert, wird die Kante geloescht. Sonst bleibt der Graph
	 * unveraendert.
	 * 
	 * @param pNode1
	 *            Knoten
	...
	/**
	 * Die Anfrage liefert den Wert true, wenn alle Knoten des Graphen markiert
	 * sind, sonst liefert sie den Wert false.
	 * 
	...
	/**
	 * Die Anfrage liefert eine Liste, die alle Nachbarknoten des Knotens pNode
	 * enthaelt.
	 * 
	 * @param pNode
	 *            Knoten
